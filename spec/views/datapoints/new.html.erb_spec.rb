...
RSpec.describe "datapoints/new", :type => :view do
  before(:each) do
    assign(:datapoint, Datapoint.new(
      :publisher => nil,
      :titlexpath => "MyString",
      :titlecss => "MyString",
      :titleregex => "MyString",
  ...
  it "renders new datapoint form" do
    render

    assert_select "form[action=?][method=?]", datapoints_path, "post" do
